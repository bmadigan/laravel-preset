...
class Preset extends BasePreset
{
    ...
    public function run()
    {
        ...
        if ($this->options['remove_after_install']) {
            $this->command->task('Remove bmadigan/laravel-preset', function () {
                $this->runCommand('composer remove bmadigan/laravel-preset');
                $this->runCommand('composer dumpautoload');
            });
        }
    ...
    private function gatherOptions()
    {
        return [
            ...
            'remove_after_install' => $this->command->confirm('Remove bmadigan/laravel-preset after install?', true),
        ];
    }
